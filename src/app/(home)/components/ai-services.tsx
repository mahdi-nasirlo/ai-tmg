import SmartSupport from "./ai-services/smart-support";
import SpeechToText from "./ai-services/speech-to-text";
import FaceRecognition from "./ai-services/face-recognition";
import OrderStatus from "./ai-services/order-status";
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20 animate-fade-in">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              مجموعه کامل سرویس‌های هوش مصنوعی طراحی شده برای بهبود عملکرد و
              تجربه کاربری سازمان شما
            </p>
